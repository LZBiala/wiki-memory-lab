...
session 03: stuff-everything loads 6 notes / 333 tokens; no-memory loads 0 and fails 1 task(s) that needed remembered facts
session 04: stuff-everything loads 9 notes / 496 tokens; no-memory loads 0 and fails 2 task(s) that needed remembered facts
session 05: stuff-everything loads 10 notes / 558 tokens; no-memory loads 0 and fails 3 task(s) that needed remembered facts
session 06: stuff-everything loads 12 notes / 659 tokens; no-memory loads 0 and fails 3 task(s) that needed remembered facts
